        ...
        <section className="flex justify-center py-20 bg-white">
            <div className="max-w-[1400px] w-full px-6">
                ...
                <div className="text-center">
                    <h3 className="text-[35px] md:text-[48px] font-bold mb-12 tracking-tight text-slate-900">
                        Nossos Clientes
                    </h3>
                    <p className="text-[19px] mt-[-50px] mb-[50px]">Ao longo de 15 anos de história, tivemos o privilégio de construir parcerias sólidas, desenvolvendo <br /> soluções que unem estratégia e tecnologia para superar desafios reais de mercado.</p>
                </div>
