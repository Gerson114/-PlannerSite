        ...
        <section className="flex justify-center">
                <div className="max-w-[1400px] border rounded-[8px] w-full">
                    ...
                    <div className="p-[50px]">
                        <h2 className="text-[32px] md:text-[48px] font-extrabold">O Risco da Inércia Digital</h2>

                        <p className="text-[19px] mt-[15px]">Empresas que não investem na profissionalização de sua experiência digital sofrem com
                        ...
                        <p className="mt-[30px] text-[19px]">A integração entre uma identidade forte e uma plataforma tecnológica eficiente é o que
                        ...
                        <div className="mt-[30px] flex justify-between items-center">
                            <p><strong className="text-[19px]">Sua estrutura digital está pronta para
