        ...
        <section className="flex justify-center px-4 mt-[-100px] py-12 lg:py-20">
            <div className="max-w-[1400px] w-full">
                ...
                <div className="max-w-[1000px]">
                    <h2 className="text-[32px] md:text-[48px] font-extrabold leading-[1.1]">Transformando <br /> Identidade em Ativo</h2>
                    <p className="mt-6 text-[18px] md:text-[19px] text-gray-700 leading-relaxed">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mt-10">
                    ...
                    <div className="flex flex-col space-y-8 py-2 order-1 lg:order-2">
                        <h2 className="text-[32px] md:text-[48px] font-extrabold leading-[1.1]">Branding e <br /> Identidade de Marca</h2>
                        <p className="text-[18px] md:text-[19px]">Uma marca forte é aquela que ocupa um lugar
                ...
                <div className="mt-20">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mt-10">
                        ...
                        <div className="flex flex-col space-y-8 py-2 order-1 lg:order-1">
                            <h2 className="text-[32px] md:text-[48px] leading-[1.1] font-extrabold">Desenvolvimento Web de Alta Performance</h2>
                            <p className="text-[18px] md:text-[19px]">O seu site é o seu principal ativo de conversão.
                ...
                <div className="mt-20">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mt-10">
                        <div className="flex flex-col space-y-8 py-2 order-1 lg:order-2">
                            <h2 className="text-[32px] md:text-[48px] font-extrabold leading-[1.1]">E-commerce e Ecossistemas de Venda</h2>
                            <p className="text-[18px] md:text-[19px]">Vender online exige mais do que uma vitrine;
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mt-20">
                    ...
                    <div className="flex flex-col space-y-8 py-2 order-1 lg:order-1">
                        <h2 className="text-[32px] md:text-[48px] leading-[1.1] font-extrabold">Produção Audiovisual e Shooting</h2>
                        <p className="text-[18px] md:text-[19px]">A imagem é o primeiro filtro de confiança do
                ...
                <div className="mt-20">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mt-10">
                        <div className="flex flex-col space-y-8 py-2 order-1 lg:order-2">
                            <h2 className="text-[32px] md:text-[48px] font-extrabold leading-[1.1]">Engenharia de Conteúdo e Copywriting</h2>
                            <p className="text-[18px] md:text-[19px]">A comunicação estratégica é o que converte
