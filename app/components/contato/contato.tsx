                        ...
                        >
                            ...
                            <div className="flex flex-col gap-6 md:gap-8 w-full">
                                <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="flex flex-col md:flex-row items-center md:items-start gap-4">
                                    <div className="flex items-center justify-center min-w-[60px] h-[60px] border-1 border-black rounded-[8px] text-black">
                            ...
                            <div className="flex gap-4 mt-6">
                                {[
                                    ...
                                    <motion.a 
                                        ...
                                        whileTap={{ scale: 0.9 }}
                                        className="flex items-center justify-center w-[60px] h-[60px] border-1 border-black rounded-[8px] text-black hover:bg-black hover:text-white transition-all duration-300"
                                    >
