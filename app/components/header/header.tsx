...
export default function Headertop() {
    ...
    return (
        <div ref={headerRef} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="hidden md:block relative z-[999]">
                        ...
                        {active === "sobre" && (
                            <div className="flex flex-1 w-full bg-gradient-to-r from-[#DFDBFC] to-white rounded-[8px] overflow-hidden">
                                <div className="flex-1 my-auto">
                                    ...
                                    <p className="px-9 text-[18px] text-gray-600 max-w-[500px] pb-4">
                                        Estratégia, tecnologia e criatividade unidas para levar sua marca ao próximo nível.
                                    </p>
                                    <div className="px-9 gap-4 flex pb-9">
                                        <Link href="/pages/Quem-Somos" className="p-3 px-6 font-bold bg-[#432CF3] text-white rounded-[8px] hover:bg-[#3221b5] transition-all">
                                            Saiba mais
                                        </Link>
                                    </div>
                                </div>
                                <div className="flex p-7 justify-center">
                                    <div className="pr-4 max-w-[500px] w-full">
                                        <Image src={img} width={500} height={400} alt="Equipe Agência Planner" className="rounded-[8px] object-cover" />
                                    </div>
                                </div>
                            </div>
                        )}
            ...
            <a href="https://wa.me/5511000000000" target="_blank" rel="noopener noreferrer" aria-label="Fale conosco pelo WhatsApp" className="hidden md:flex fixed right-8 bottom-8 z-[100] bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:bg-[#20BA5A] transition-all hover:scale-110">
