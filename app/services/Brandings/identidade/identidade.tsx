        ...
        <section className="flex justify-center px-4 mt-[-100px] py-12 lg:py-20">
            <div className="max-w-[1400px] w-full">
                ...
                <div className="max-w-[1000px]">
                    <h2 className="text-[36px] md:text-[48px] leading-[1.1] font-bold text-gray-900">
                        Transformando <br /> Identidade em Ativo
                    </h2>
                    <p className="mt-6 text-[18px] md:text-[19px] text-gray-700 leading-relaxed">
                        Para escalar com previsibilidade, uma empresa precisa de umsa base sólida onde cada ponto de contato reforce sua autoridade. Nossa abordagem integra design, tecnologia e narrativa para garantir que sua presença digital seja uma extensão fiel do seu valor comercial.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mt-10">
                    ...
                    <div className="flex flex-col space-y-8 py-2 order-1 lg:order-2">
                        <p className="text-[36px] md:text-[48px] font-extrabold leading-[1.1]">Branding e <br /> Identidade de Marca</p>
