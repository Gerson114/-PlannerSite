...
export default function Contato() {
    // Variantes para animação de cascata nos itens de contato
    const fadeInUp = {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-[40px] lg:gap-[80px]">
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-6 md:gap-8 w-full">
                                <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="flex flex-col md:flex-row items-center md:items-start gap-4">
                                ...
                                <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ delay: 0.2 }} className="flex flex-col md:flex-row items-center md:items-start gap-4">
                                    <div className="flex items-center justify-center min-w-[60px] h-[60px] border-2 border-black rounded-[12px] text-black">
                            ...
                            <div className="flex gap-4 mt-6">
                                {[
                                    ...
                                    <motion.a 
                                        ...
                                        whileTap={{ scale: 0.9 }}
                                        className="flex items-center justify-center w-[60px] h-[60px] border-2 border-black rounded-[12px] text-black hover:bg-black hover:text-white transition-all duration-300"
                                    >
                            ...
                            <div className="bg-[#432CF3] p-[30px] md:p-[60px] rounded-[20px] shadow-xl">
                                <form action="" className="flex flex-col gap-[15px] md:gap-[20px]">
                                    {[
                                        ...
                                        <div key={idx} className="flex flex-col text-[17px] md:text-[19px] text-white">
                                            ...
                                            <motion.input 
                                                ...
                                                className="bg-white py-[10px] md:py-[12px] px-[15px] rounded-[10px] text-black outline-none w-full transition-shadow focus:shadow-lg" 
                                                type={field.type} 
                                            />
                                        </div>
                                    ))}
                                    ...
                                    <div className="flex flex-col text-[17px] md:text-[19px] text-white">
                                        ...
                                        <motion.textarea 
                                            whileFocus={{ scale: 1.01 }}
                                            className="bg-white h-[120px] md:h-[150px] rounded-[10px] text-black p-[15px] outline-none resize-none w-full transition-shadow focus:shadow-lg" 
                                            id="textarea"
                                        ></motion.textarea>
                                    </div>
                                    ...
                                    <motion.button 
                                        ...
                                        whileTap={{ scale: 0.98 }}
                                        className="mt-[10px] md:mt-[20px] bg-black text-white py-[12px] md:py-[15px] rounded-[10px] font-bold text-[16px] md:text-[18px] hover:bg-[#1a1a1a] transition-colors w-full shadow-lg"
                                    >
                                        Enviar Mensagem
                                    </motion.button>
                                </form>
